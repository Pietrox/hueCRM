...
import {LeadsParamExampleEnum} from './lib/leads-param-example.enum';
import {LeadsParamsEnum} from './lib/leads-params.enum';
import {UserParamExampleEnum} from './lib/user-param-example.enum';
...
export const userParams = UserParamsEnum;
export const userParamExample = UserParamExampleEnum;
export const leadsParams = LeadsParamsEnum;
export const leadsParamExample = LeadsParamExampleEnum;
